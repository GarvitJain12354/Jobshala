    ...
    <>
      <div className="flex  gap-2 py-6">
        ...
        <div className="flex flex-col gap-1 p-6 px-16 w-[80%] ">
            ...
            <div className="flex flex-col">
              <div className="flex w-full items-center justify-between">
                ...
                <div className="icon flex items-center text-2xl gap-3 cursor-pointer">
                  ...
                  ></i>
                  <i
                    onClick={() => deleteeducation(dets?.id)}
                    className="ri-delete-bin-7-line"
                  ></i>
                </div>
              </div>
              <h3 className="text-sm">
                {dets?.organization},{dets?.location}
              </h3>
              <h3 className="text-sm">
                {dets?.start} - {dets?.end}
              </h3>
          ...
          >
            <i className="ri-add-fill"></i> Add portfolio/ work sample
          </div>
        </div>
      </div>
      ...
      >
        <DialogTitle className="w-full text-center text-black text-2xl font-semibold">
              ...
              <div className="grid grid-cols-2 items-center place-items-center gap-1">
                ...
                <div className="flex flex-col ml-auto items-start w-[42vw] gap-4">
                  ...
                  <textarea
                    ...
                    className="w-full border-2 p-4 rounded-lg h-56"
                    style={{ resize: "none" }}
                    id=""
                    cols="30"
                    rows="10"
