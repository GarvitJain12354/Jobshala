...
dispatch(getstudent());
  ...
  return (
    <>
        ...
        <div className="flex items-center font-semibold justify-center gap-8 ">
        <h2 >Internships</h2>
          <h2>Jobs</h2>
          <h2>Courses <span className='bg-orange-400 px-[.6rem] rounded-lg text-sm font-semibold text-white py-[.2rem]'>OFFERS</span></h2>
