...
import { editIntern, editJob, uploadJob } from "@/store/Action/action";
...
const EditIntern = ({open,setOpen,data}) => {
...
dispatch(editIntern(data?.id,info))
setOpen(false)
...
setdiscription(data?.discription || "")
  ...
  return (
    <>
      ...
      >
        <DialogTitle className="w-full text-center text-black text-2xl font-semibold">{"Edit Internship Details"}</DialogTitle>
        <DialogContent>
