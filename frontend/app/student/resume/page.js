...
const page = () => {
  const { message, error, isAuthenticated, user, msg, loading } = useSelector(
  ...
  useEffect(() => {
    ...
    const languageNames =
      user?.language?.map((language) => ({ name: language.name })) || [];
          ...
          <div className="flex flex-col gap-2 py-2 pb-6 ">
            <div className="flex gap-6 items-center">
              ...
              <i
                ...
                className="ri-pencil-line text-3xl font-extralight cursor-pointer"
              ></i>
            </div>
        ...
        <DialogContent dividers>
          <form onSubmit={resumeSubmit} encType="multipart-formdata">
            <div className="w-full grid grid-cols-2 gap-4 items-center place-content-center overflow-hidden">
              ...
              <div
                className="flex shrink-0 items-start flex-col gap-4 p-2 w-screen"
                onClick={openfile}
              >
                <h1>
                  Profile Picture{" "}
              ...
              <span className="w-screen">
                <Alert severity="info">
                  ...
                  and max resolution: 500px x 500px. File type -{" "}
              ...
              <span className="relative p-2 h-full">
                <Link
                  className="absolute bottom-2 font-semibold text-sm text-blue-800 cursor-pointer right-5 "
                  href={"/student/changeemail"}
                >
                  Change Email
                </Link>
              </span>
